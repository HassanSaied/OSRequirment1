...
_DEPS =clk_utilities.h generic_queue.h process_queue.h queue_utilities.h defs.h headers.h process_struct.h highest_priority_first.h shortest_remaining_time_first.h round_robin.h cpu_util.h

DEPS = $(patsubst %,$(IDIR)/%,$(_DEPS))

_OBJ =clk.o generic_queue.o process_generator.o scheduler.o files_generator.o process.o process_queue.o highest_priority_first.o shortest_remaining_time_first.o round_robin.o cpu_util.o
